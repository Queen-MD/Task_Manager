  ...
  return (
    <div className="modal-backdrop flex items-center justify-center p-4">
      <div className="modal-content max-w-lg w-full max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="flex items-center justify-between p-8 border-b border-gray-200/50 bg-gradient-to-r from-blue-50/50 to-indigo-50/50">
          ...
          <div className="animate-slide-in-left">
            ...
            <div className="relative group">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                <Type className="h-5 w-5 text-gray-400 group-focus-within:text-blue-500 transition-colors duration-200" />
              </div>
              <input
                type="text"
                id="title"
                name="title"
                required
                className={`input-field pl-12 ${errors.title ? 'ring-red-500 border-red-500' : 'group-focus-within:ring-blue-500'}`}
          ...
          <div className="animate-slide-in-right">
            ...
            <div className="relative group">
              ...
              <textarea
                ...
                name="description"
                rows={4}
                className="input-field pl-12 resize-none group-focus-within:ring-blue-500"
          ...
          <div className="animate-slide-in-left">
            ...
            <div className="relative group">
              ...
              <input
                ...
                name="due_date"
                min={getTodayDate()}
                className={`input-field pl-12 ${errors.due_date ? 'ring-red-500 border-red-500' : 'group-focus-within:ring-blue-500'}`}
